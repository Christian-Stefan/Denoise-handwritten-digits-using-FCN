...
# Hi :)
# Please READ THROUGH this set of instructive commentaries, to make sure the rerun of the code is flawless
...
# -------- Second Block -------- #
# In order to execute the second block please make sure that both blocks, the SECOND but ALSO THE FIRST are uncommented;
# Uncomment the part bellow ||||||||||||||| Uncomment the part bellow
# Uncomment the part bellow vvvvvvvvvvvvvvv Uncomment the part bellow
