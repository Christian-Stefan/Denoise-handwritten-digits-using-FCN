...
def training(model, loc, batch_size, basisc_transf, activation, width, epochs, model_label, saving_path, AUTOMATIC=True):
        ...
        raw_history_frame.to_csv(f"weights\{model_label}_accuracy_container\history.csv")
...
# )
    ...
    training(model, loc, batch_size, basisc_transf, 
                        ...
                        model_label="Default Model Detector", AUTOMATIC=False, saving_path=defaultFCN_hist_path)
